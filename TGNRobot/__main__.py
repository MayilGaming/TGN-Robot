...
START_IMG = "https://telegra.ph/file/7cf9d368347d85881c9d4.mp4"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Lucifer](t.me/detctective_de) \
 Supporting isnt always financial! [ ɴᴇᴛᴡᴏʀᴋ](https://t.me/mgbotslists) \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= "<code>Mayil is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
    ...
    if query.data == "zaid_":
        query.message.edit_text(
            text=""" ℹ️ I am [TGN Robot](t.me/TGN_Ro_bot), a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://t.me/mgbotslists/16).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I am [Mayil](t.me/t.me/Mayil_The_Group_Manager)
                 \nHere is the [Source Code](https://t.me/mgbotslists/16) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I Am Back To Form")
        except Unauthorized:
            LOGGER.warning(
